...
namespace WindowsFormsApplication1.DAO
{
    class ProduktDAO
    {
        ...
        public static void InsertSQL(string nazwa, char kategoria, WartosciOdzywcze wartosciOdzywcze)
        {
            ...
            {
                connection.Open();
                string sql = $"INSERT Produkt(Nazwa, Kategoria, " +
                    $"Energia, Bialko, Tluszcze, Kwasy, Weglowodany, Cukry, Blonnik, Sod, " +
                    $"WitA, WitB1, WitB2, WitB6, WitB12, " +
                    $"Niacyna, WitC, WitD, WitE, WitK, " +
                            $"Foliany, Fosfor, Magnez, Zelazo, Cynk, Selen, Miedz, Cholina, " +
                            $"KwasPantotenowy, Biotyna, Mangan, Fluor, Potas, Jod) " +
                            $"VALUES ('{nazwa}', '{kategoria}', " +
                            $"{wartosciOdzywcze.energia}, {wartosciOdzywcze.bialko}, {wartosciOdzywcze.tluszcze}, {wartosciOdzywcze.tluszcze_nn}, {wartosciOdzywcze.weglowodany}, {wartosciOdzywcze.cukry}, {wartosciOdzywcze.blonnik}, {wartosciOdzywcze.sod}, " +
                            $"{wartosciOdzywcze.witA}, {wartosciOdzywcze.witB1}, {wartosciOdzywcze.witB2}, {wartosciOdzywcze.witB6}, {wartosciOdzywcze.witB12}, " +
                            $"{wartosciOdzywcze.niacyna}, {wartosciOdzywcze.witC}, {wartosciOdzywcze.witD}, {wartosciOdzywcze.witE}, {wartosciOdzywcze.witK}, " +
                            $"{wartosciOdzywcze.foliany}, {wartosciOdzywcze.fosfor}, {wartosciOdzywcze.magnez}, {wartosciOdzywcze.zelazo}, {wartosciOdzywcze.cynk}, {wartosciOdzywcze.selen}, {wartosciOdzywcze.miedz}, {wartosciOdzywcze.cholina}," +
                            $" {wartosciOdzywcze.kwasPantotenowy}, {wartosciOdzywcze.biotyna}, {wartosciOdzywcze.mangan}, {wartosciOdzywcze.fluor}, {wartosciOdzywcze.potas}, {wartosciOdzywcze.jod});";
