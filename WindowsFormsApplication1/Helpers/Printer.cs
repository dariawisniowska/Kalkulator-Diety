    ...
    public class Printer
    {
        ...
        public static void Jadlospis(Jadlospis jadlospis)
        {
            try
            {
                ...
                {
                    path = @"Jadłospisy/" + jadlospis.miasto + "/" + data.Year + "/" + data.Month + "/" + data.Day + "/" + jadlospis.data + ", " + jadlospis.dieta.nazwa + " 2000.docx";
                }
                using (DocX document = DocX.Create(path))
                    {
                        ...
                        if (jadlospis.dieta.kod!=null && jadlospis.dieta.kod != "" && !jadlospis.miasto.Contains("pudełko"))
         ...
         // .Color(Color.Black);
                   ...
                   //            .FontSize(8)
                    ...
                    if(jadlospis.miasto.Contains("pudełko"))
                    {
                        ...
                        System.IO.Directory.CreateDirectory("Jadłospisy/" + jadlospis.miasto + "/" + data.Year + "/" + data.Month + "/" + data.Day);
                        path = @"Jadłospisy/" + jadlospis.miasto + "/" + data.Year + "/" + data.Month + "/" + data.Day + "/" + jadlospis.data + ", " + jadlospis.dieta.nazwa +" 1500"+ ".docx";
            ...
            try
            {
                if (listaJadlospisow.Count > 0)
                {
                    ...
                    var picture_lesko = image_lesko.CreatePicture(39, 125);
                        ...
                        if (!listaJadlospisow[0].miasto.Contains("pudełko"))
                        {
                            if (listaJadlospisow[0].miasto == "Lesko")
                            {
                                t0.Rows[0].Cells[2].Paragraphs[0].AppendPicture(picture_lesko);
                                t0.Rows[0].Cells[2].Paragraphs[0].Alignment = Alignment.center;
                            }
                        ...
                        foreach (Jadlospis jadlospis in listaJadlospisow)
                        {
                            ...
                            string opis = $"\r\n{jadlospis.dieta.nazwa}";
                            if (jadlospis.dieta.kod != null && jadlospis.dieta.kod != "" && !listaJadlospisow[0].miasto.Contains("pudełko"))
                                opis = $"\r\n{jadlospis.dieta.nazwa} ({jadlospis.dieta.kod})";
        ...
        public static void JadlospisNaStrone(List<Jadlospis> listaJadlospisow)
        {
            try
            {
                if (listaJadlospisow.Count > 0)
                {
                    System.IO.Directory.CreateDirectory("Jadłospisy na stronę/" + listaJadlospisow[0].miasto);
                    string path = @"Jadłospisy na stronę/" + listaJadlospisow[0].miasto + "/" + listaJadlospisow[0].data + ".docx";
                    ...
                    using (DocX document = DocX.Create(path))
                    {
                        ...
                        foreach (Jadlospis jadlospis in listaJadlospisow)
                        {
                            if ((jadlospis.miasto == "Ustrzyki Dolne" && (jadlospis.dieta.nazwa == "Dieta podstawowa" || jadlospis.dieta.nazwa == "Dieta z ograniczeniem łatwo przyswajalnych węglowodanów 3 posiłkowa"))||
                                (jadlospis.miasto == "Lesko" && (jadlospis.dieta.nazwa == "Dieta podstawowa" || jadlospis.dieta.nazwa == "Dieta z ograniczeniem łatwo przyswajalnych węglowodanów")))
                            {
